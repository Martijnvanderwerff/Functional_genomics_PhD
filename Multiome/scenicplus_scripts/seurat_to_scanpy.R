...
write10xCounts(x = seurat_obj_subset@assays$SCT@counts, path = '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/scenic_plus/scenic_workflow/seurat_object/mono_10000/seurat_10x_format')